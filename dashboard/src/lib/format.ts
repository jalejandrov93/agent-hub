/**
 * Pure string/number formatting helpers. Ported 1:1 from the legacy
 * src/dashboard/ui/format.js (esc() is dropped — React escapes text nodes
 * itself, so there is no HTML-string templating left in this codebase).
 */
